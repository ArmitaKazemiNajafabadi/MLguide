# Machine Learning Keywords & Glossary

> Comprehensive reference with definitions, examples, and Q&A

**Source:** Coursera - Generative AI Introduction and Applications

---

| Term | Definition | Examples | Q&A |
|------|------------|----------|-----|
| **Data Augmentation** | Technique to increase diversity/amount of training data via transformations | 1. Image: rotation, flip, crop, color jitter<br>2. Text: synonym replacement, back-translation | **Q:** Why not just collect more data?<br>**A:** Expensive/time-consuming; augmentation is cheaper and improves model robustness to variations |
...
| **Diffusion Model** | Generative model: trains by adding noise to data, learns to remove noise (reverse diffusion) | 1. Stable Diffusion (images)<br>2. DALL-E 2 (text-to-image) | **Q:** How is it different from GAN?<br>**A:** Diffusion = iterative denoising (stable training); GAN = adversarial game (generator vs discriminator, harder to train) |
...
| **Foundation Models** | Large pre-trained models with broad capabilities; adaptable to specific tasks via fine-tuning | 1. GPT-4 (text)<br>2. CLIP (vision-language) | **Q:** Why called "foundation"?<br>**A:** Serve as base for many downstream tasks; one model → many applications via transfer learning |
...
| **Generative AI Models** | Models understanding input context to generate new content; used for content creation/interaction | 1. GPT (text)<br>2. Stable Diffusion (images) | **Q:** Always need prompts?<br>**A:** For conditional generation (text-to-image), yes; unconditional models can generate without prompts (random samples) |
